...
<head>
    ...
    <title>APLIKASi | LAPOR SAJA</title>
    ...
    <main id="main">
            ...
            <div class="container">
                ...
                <div class="row content">
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="150">
                        <p>
                        <h3>LAPOR SAJA</h3> adalah sistem laporan pengaduan Masyarakat yang dibuat untuk memudahkan
                        Masyarakat untuk memberikan laporan atau informasi kepada pihak yang berwenang
                        </p>
                        <ul>
                            <h3>Tujuan LAPOR SAJA</h3>
                            <li><i class="ri-check-double-line"></i>Memberikan Informasi atau laporan yang jelas kepada
                                pihak yang berwenang supaya bisa ditindak lebih lanjut</li>
                            <li><i class="ri-check-double-line"></i>Mempermudah Masyarakat untuk berkomunikasi dengan
                                pihak yang berwenang</li>
                        </ul>
                    </div>
                    <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-up" data-aos-delay="300">
                        <p>
                        <h4>LAPOR SAJA</h4>merupakan komitmen kami untuk melayani Masyarakat. Dengan hadirnya sistem
                            ...
                            <div class="row">
                                <div class="col-md-6 d-md-flex align-items-md-stretch">
                                    <div class="count-box">
                                        ...
                                        <p><strong>Pengguna</strong><br>DAFTAR pengguna LAPOR SAJA</p>
                                    </div>
                                </div>
        ...
        <section id="services" class="services">
            <div class="container">
                ...
                <div class="section-title" data-aos="fade-up">
                    <h2>TATA CARA</h2>
                    <p>Nah ini dia alur pelaporan yang ada website LAPOR SAJA</p>
                </div>
